...
import theFencer.patches.relics.BottledPlaceholderField;
import theFencer.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static theFencer.FencerMod.makeRelicOutlinePath;
import static theFencer.FencerMod.makeRelicPath;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = FencerMod.makeID("BottledPlaceholderRelic");
