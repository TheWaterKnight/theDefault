...
import theFencer.relics.DefaultClickableRelic;
import theFencer.relics.PlaceholderRelic;
import theFencer.relics.PlaceholderRelic2;
import theFencer.util.IDCheckDontTouchPls;
import theFencer.util.TextureLoader;
import theFencer.variables.DefaultCustomVariable;
import theFencer.variables.DefaultSecondMagicNumber;
...
@SpireInitializer
public class FencerMod implements
        EditCardsSubscriber,
    ...
    private static final String MODNAME = "The Fencer Mod";
    private static final String AUTHOR = "TwK and Roux"; // And pretty soon - You!
    private static final String DESCRIPTION = "A base for Slay the Spire to start your own mod from, feat. the Fencer.";
    ...
    private static final String ATTACK_DEFAULT_GRAY = "theFencerResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "theFencerResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "theFencerResources/images/512/bg_power_default_gray.png";
    
    private static final String ENERGY_ORB_DEFAULT_GRAY = "theFencerResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "theFencerResources/images/512/card_small_orb.png";
    
    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "theFencerResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "theFencerResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "theFencerResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "theFencerResources/images/1024/card_default_gray_orb.png";
    
    // Character assets
    private static final String THE_DEFAULT_BUTTON = "theFencerResources/images/charSelect/DefaultCharacterButton.png";
    private static final String THE_DEFAULT_PORTRAIT = "theFencerResources/images/charSelect/DefaultCharacterPortraitBG.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "theFencerResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "theFencerResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "theFencerResources/images/char/defaultCharacter/corpse.png";
    
    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "theFencerResources/images/Badge.png";
    
    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "theFencerResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "theFencerResources/images/char/defaultCharacter/skeleton.json";
    ...
    public static void setModID(String ID) { // DON'T EDIT
        ...
        InputStream in = FencerMod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THIS ETHER
    ...
    private static void pathCheck() { // ALSO NO
        ...
        InputStream in = FencerMod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THISSSSS
        IDCheckDontTouchPls EXCEPTION_STRINGS = coolG.fromJson(new InputStreamReader(in, StandardCharsets.UTF_8), IDCheckDontTouchPls.class); // NAH, NO EDIT
        String packageName = FencerMod.class.getPackage().getName(); // STILL NO EDIT ZONE
    ...
    public static void initialize() {
        ...
        FencerMod defaultmod = new FencerMod();
    ...
    public void receiveEditCards() {
        ...
        new AutoAdd("theFencer") // ${project.artifactId}
